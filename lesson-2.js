// ОПЕРАТОР ИНКРИМЕНТ(увеличивает на единицу) и ДЕКРИМЕНТ(уменьшает на единицу )
  // ++a увеличивает значение, префиксный инкримент
  // а++ увеличивает значение, постфиксный инкримент
  // --а уменьшает значениие, префиксный декримент
  // а-- уменьшает значениие, постфиксный декримент
...
//ВЫВЕСТИ ПЕРВЫЕ 5 ЧИСЕЛ ФИБОНАЧИ
  var n = 5;
  var preLast = 0;
  var last = 1;
...
// МАСИВ - множество данных - набор значений 
